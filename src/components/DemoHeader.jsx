...
export default function DemoHeader({ route, setRoute }) {
  ...
  return (
    <header className="demo-header">
      <div className="brand" onClick={() => setRoute('home')} role="button" tabIndex={0}>
        <div className="brand-mark">QI</div>
        <div>
          <div className="brand-title">Quadracure Innovators</div>
          <div className="brand-subtitle">NATEC production ×5 · Digital thread demo</div>
        </div>
      </div>
      ...
      <div className={`realtime-pill ${isFirebaseConfigured ? 'online' : 'offline'}`}>
        <span />
